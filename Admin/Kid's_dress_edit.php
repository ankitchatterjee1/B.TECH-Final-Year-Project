...
<?php
	...
	$i = 0;
	$sql="SELECT * FROM `kid's_dress` WHERE `label` = 'Kid dress'";
          ...
          <div class="Style-form">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
				<center><h1>EDIT KID DRESS</h1></center>
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					?>
                        <tr>
                          ...
                          <td><?php echo "<img style='height:100px; width:100px;' src='../upload/kid dress/".$row[4]."'>";?></td>
						  <th>
								<a href="Kid's_dress_update.php?id=<?php echo $row[0];?>">EDIT </a>|
								<a href="Kid's_dress_delete.php?id=<?php echo $row[0];?>">DELETE</a>
						  </th>
                        </tr>
					<?php
						$i++;
