<?php
   ...
   if(isset($_POST["Submit"]))
   {
	 ...
	 // $date=date("y-m-d");
      ...
      $sql = "INSERT INTO `blazer`(`name`, `price`, `details`, `image`, `label`,`Web ID:`) VALUES ('$Name','$amount','$details','$new_file_name1','Blazer','$productId')";  
        
			if(mysqli_query($con,$sql)){
				
				if(move_uploaded_file($_FILES["pic"]["tmp_name"], $target_file1))
				 {
						header("location:blazer.php?msg=ok");
				 }		
			}	
            else{
