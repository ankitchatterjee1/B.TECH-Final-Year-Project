<?php
   ...
   if(isset($_POST["Submit"]))
   {
	 ...
	 // $date=date("y-m-d");
      ...
      $sql = "INSERT INTO `kid's_sunglass`(`name`, `price`, `details`, `image`, `label`,`Web ID:`) VALUES ('$Name','$amount','$details','$new_file_name1','Kid sunglass','$productId')";  
        
			if(mysqli_query($con,$sql)){
				
				if(move_uploaded_file($_FILES["pic"]["tmp_name"], $target_file1))
				 {
						header("location:Kid's_Sunglass.php?msg=ok");
				 }		
			}	
            else{
