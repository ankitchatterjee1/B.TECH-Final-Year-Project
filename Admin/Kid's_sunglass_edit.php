...
<?php
	...
	$i = 0;
	$sql="SELECT * FROM `kid's_sunglass` WHERE `label` = 'Kid sunglass'";
          ...
          <div class="Style-form">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
				<center><h1>EDIT KID SUNGLASS</h1></center>
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th style="height:30px; width:150px;">IMAGE</th>
					...
					?>
                        <tr>
                          ...
                          <td><?php echo "<img style='height:100px; width:100px;' src='../upload/kid sunglass/".$row[4]."'>";?></td>
						  <th>
								<a href="Kid's_sunglass_update.php?id=<?php echo $row[0];?>">EDIT </a>|
								<a href="Kid's_sunglass_delete.php?id=<?php echo $row[0];?>">DELETE</a>
						  </th>
                        </tr>
					<?php
						$i++;
