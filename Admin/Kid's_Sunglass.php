...
<style>
	...
	<div class="Style_left"> 
	    <div class="Style-form"> 
			<form action="kid_sunglass_upload.php" method="post" enctype="multipart/form-data">
				<center><h2><b>Kid Sunglass</b></h2></center>   
				<table>
					<tr>
					   <td>Brand Name :&nbsp;&nbsp;</td>
					   <td><input type="text" id="brand" name="name" placeholder="brand name"></td>
					   <td class="span"></td>
                    </tr>    
