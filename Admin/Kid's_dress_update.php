...
<?php
	...
	{
		$id=$_GET['id'];	
		$sql="SELECT * FROM `kid's_dress` WHERE `id`='$id'";
...
<style>
	...
	<div class="Style_left"> 
	      <div class="Style-form">
			<form action="Kid's_dress_update_successful.php?id=<?php echo $row[0];?>" method="post" enctype="multipart/form-data">
				<center><h2>KID DRESS UPDATE</h2></center>   
				<table>
					<tr>
					   <td>Name</td>
				...
				<table>
						<tr>
						   ...
						   <td>
								<?php echo "<img id='output' style='height:100px; width:100px;' src='../upload/kid dress/".$row[4]."'>";?>
						   </td>
